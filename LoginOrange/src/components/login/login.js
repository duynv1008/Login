                ...
                <View style={[styles.content]}>
                    <View style={[styles.form]}>
                        <Item rounded style={[styles.itemInput]}>
                            <Icon name='mail' type="MaterialIcons" style={[styles.itemIcon]}/>
                            <Input placeholder="Email" placeholderTextColor="#959595" autoCorrect={false} returnKeyType={"next"} onSubmitEditing={(event) => { this.refs.passwordInput._root.focus(); }} style={{padding:0}}/>
                        </Item>
                        <Item rounded style={[styles.itemInput]}>
                        ...
                        <Item style={[styles.noneBoderBottom, styles.itemInput,{ justifyContent: "flex-end" }]}>
                    ...
                    <View style={[styles.footer]}>
                        <Text>Don't have an account ?<Text style={{color:"#F5591F"}} button onPress={()=>Actions.Register()}> Register</Text></Text>
                    </View>
                </View>
            </Container>
        );
...
const styles = StyleSheet.create({
    ...
    itemIcon:{color:'#ddd',fontSize:20,paddingLeft: 10,}
});